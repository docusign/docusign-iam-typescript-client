...
/** @internal */
export type WorkspaceUploadRequest$Outbound = {
...
/** @internal */
export const WorkspaceUploadRequest$outboundSchema: z.ZodType<
 ...
 */
export namespace WorkspaceUploadRequest$ {
  /** @deprecated use `WorkspaceUploadRequest$inboundSchema` instead. */
  export const inboundSchema = WorkspaceUploadRequest$inboundSchema;
  /** @deprecated use `WorkspaceUploadRequest$outboundSchema` instead. */
  export const outboundSchema = WorkspaceUploadRequest$outboundSchema;
  /** @deprecated use `WorkspaceUploadRequest$Outbound` instead. */
  export type Outbound = WorkspaceUploadRequest$Outbound;
}

export function workspaceUploadRequestToJSON(
  workspaceUploadRequest: WorkspaceUploadRequest,
): string {
  return JSON.stringify(
    WorkspaceUploadRequest$outboundSchema.parse(workspaceUploadRequest),
  );
}
