...
/** @internal */
export type UpdateWorkspaceResponse$Outbound = {
  workspace_id: string;
  name?: string | null | undefined;
...
/** @internal */
export const UpdateWorkspaceResponse$outboundSchema: z.ZodType<
  UpdateWorkspaceResponse$Outbound,
  z.ZodTypeDef,
  UpdateWorkspaceResponse
> = z.object({
...
export namespace UpdateWorkspaceResponse$ {
  /** @deprecated use `UpdateWorkspaceResponse$inboundSchema` instead. */
  export const inboundSchema = UpdateWorkspaceResponse$inboundSchema;
  /** @deprecated use `UpdateWorkspaceResponse$outboundSchema` instead. */
  export const outboundSchema = UpdateWorkspaceResponse$outboundSchema;
  /** @deprecated use `UpdateWorkspaceResponse$Outbound` instead. */
  export type Outbound = UpdateWorkspaceResponse$Outbound;
}

export function updateWorkspaceResponseToJSON(
  updateWorkspaceResponse: UpdateWorkspaceResponse,
): string {
  return JSON.stringify(
    UpdateWorkspaceResponse$outboundSchema.parse(updateWorkspaceResponse),
  );
}
