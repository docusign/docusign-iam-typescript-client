 ...
 */
export function navigatorBulkJobUploadCompleteBulkJob(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UploadCompleteBulkJobRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/v1/accounts/{accountId}/upload/jobs/{jobId}/actions/complete",
  )(pathParams);
  ...
  >(
    ...
    M.jsonErr([400, 401, 403, 404], errors.ErrDetails$inboundSchema),
