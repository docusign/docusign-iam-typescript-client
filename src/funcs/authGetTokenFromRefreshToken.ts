...
import { GetTokenFromRefreshTokenServerList } from "../models/operations/gettokenfromrefreshtoken.js";
 ...
 */
export function authGetTokenFromRefreshToken(
  ...
  Result<
    operations.GetTokenFromRefreshTokenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AuthorizationCodeGrant$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetTokenFromRefreshTokenServerList[0], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/oauth/token#FromRefreshToken")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTokenFromRefreshTokenResponse$inboundSchema),
