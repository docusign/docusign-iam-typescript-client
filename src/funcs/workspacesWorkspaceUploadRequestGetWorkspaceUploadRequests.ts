 ...
 */
export function workspacesWorkspaceUploadRequestGetWorkspaceUploadRequests(
  client: IamClientCore,
  request: operations.GetWorkspaceUploadRequestsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetWorkspaceUploadRequestsResponse,
    | errors.ErrorDetails
    | IamClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceUploadRequestsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetWorkspaceUploadRequestsResponse$inboundSchema),
