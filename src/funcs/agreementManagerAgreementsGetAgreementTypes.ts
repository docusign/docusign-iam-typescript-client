 ...
 */
export function agreementManagerAgreementsGetAgreementTypes(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAgreementTypesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/accounts/{accountId}/agreement-types")(
    pathParams,
  );
