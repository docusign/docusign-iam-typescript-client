 ...
 */
export function workflowBuilderWorkflowsPauseNewWorkflowInstances(
  client: IamClientCore,
  request: operations.PauseNewWorkflowInstancesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PauseNewWorkflowInstancesSuccess,
    | errors.ErrDetails
    | IamClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PauseNewWorkflowInstancesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PauseNewWorkflowInstancesSuccess$inboundSchema),
    M.jsonErr([400, 401, 403, 404, 409], errors.ErrDetails$inboundSchema, {
