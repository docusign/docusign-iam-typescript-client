 ...
 */
export function workspacesWorkspaceBrandsGetWorkspaceBrand(
  client: IamClientCore,
  request: operations.GetWorkspaceBrandRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GetWorkspaceBrandResponse,
    | errors.ErrorDetails
    | IamClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWorkspaceBrandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetWorkspaceBrandResponse$inboundSchema),
