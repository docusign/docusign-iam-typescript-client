 ...
 */
export function agreementManagerAgreementsChangeAgreementType(
  client: IamClientCore,
  request: operations.ChangeAgreementTypeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ChangeAgreementTypeResponse,
    | errors.ErrDetails
    | IamClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChangeAgreementTypeRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ChangeAgreementTypeRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ChangeAgreementTypeResponse$inboundSchema),
    M.jsonErr([400, 403, 404, 422], errors.ErrDetails$inboundSchema, {
