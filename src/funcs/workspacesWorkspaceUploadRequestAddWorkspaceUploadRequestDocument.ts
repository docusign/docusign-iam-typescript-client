...
export function workspacesWorkspaceUploadRequestAddWorkspaceUploadRequestDocument(
  ...
  Result<
    components.AddWorkspaceUploadRequestDocumentResponse,
    | errors.ErrorDetails
    | IamClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AddWorkspaceUploadRequestDocumentRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      201,
      components.AddWorkspaceUploadRequestDocumentResponse$inboundSchema,
    ),
