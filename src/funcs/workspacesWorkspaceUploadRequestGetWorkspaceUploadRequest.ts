 ...
 */
export function workspacesWorkspaceUploadRequestGetWorkspaceUploadRequest(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkspaceUploadRequestRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    uploadRequestId: encodeSimple("uploadRequestId", payload.uploadRequestId, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetWorkspaceUploadRequestResponse$inboundSchema),
