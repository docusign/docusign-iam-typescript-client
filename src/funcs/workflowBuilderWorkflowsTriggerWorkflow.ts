 ...
 */
export function workflowBuilderWorkflowsTriggerWorkflow(
  client: IamClientCore,
  request: operations.TriggerWorkflowRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.TriggerWorkflowSuccess,
    | errors.ErrDetails
    | IamClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TriggerWorkflowRequest$outboundSchema.parse(value),
