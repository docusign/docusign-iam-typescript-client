...
import { navigatorAgreementsCreateAgreementSummary } from "../funcs/navigatorAgreementsCreateAgreementSummary.js";
import { navigatorAgreementsDeleteAgreement } from "../funcs/navigatorAgreementsDeleteAgreement.js";
import { navigatorAgreementsGetAgreement } from "../funcs/navigatorAgreementsGetAgreement.js";
import { navigatorAgreementsGetAgreementsList } from "../funcs/navigatorAgreementsGetAgreementsList.js";
...
export class Agreements extends ClientSDK {
  ...
  async getAgreementsList(
    ...
    return unwrapAsync(navigatorAgreementsGetAgreementsList(
      this,
      request,
      options,
    ));
  ...
  async getAgreement(
    ...
    return unwrapAsync(navigatorAgreementsGetAgreement(
      this,
      request,
      options,
    ));
  ...
  async deleteAgreement(
    ...
    return unwrapAsync(navigatorAgreementsDeleteAgreement(
      this,
      request,
      options,
    ));
   ...
   */
  async createAgreementSummary(
    request: operations.CreateAgreementSummaryRequest,
    options?: RequestOptions,
  ): Promise<components.AgreementSummary> {
    return unwrapAsync(navigatorAgreementsCreateAgreementSummary(
      this,
      request,
      options,
    ));
