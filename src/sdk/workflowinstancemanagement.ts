...
import { workflowBuilderWorkflowInstanceManagementCancelWorkflowInstance } from "../funcs/workflowBuilderWorkflowInstanceManagementCancelWorkflowInstance.js";
import { workflowBuilderWorkflowInstanceManagementGetWorkflowInstance } from "../funcs/workflowBuilderWorkflowInstanceManagementGetWorkflowInstance.js";
import { workflowBuilderWorkflowInstanceManagementGetWorkflowInstancesList } from "../funcs/workflowBuilderWorkflowInstanceManagementGetWorkflowInstancesList.js";
...
export class WorkflowInstanceManagement extends ClientSDK {
  ...
  async getWorkflowInstancesList(
    ...
    return unwrapAsync(
      workflowBuilderWorkflowInstanceManagementGetWorkflowInstancesList(
        this,
        request,
        options,
      ),
  ...
  async getWorkflowInstance(
    ...
    return unwrapAsync(
      workflowBuilderWorkflowInstanceManagementGetWorkflowInstance(
        this,
        request,
        options,
      ),
  ...
  async cancelWorkflowInstance(
    ...
    return unwrapAsync(
      workflowBuilderWorkflowInstanceManagementCancelWorkflowInstance(
        this,
        request,
        options,
      ),
