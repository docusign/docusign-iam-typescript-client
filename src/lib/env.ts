...
export interface Env {
  DOCUSIGN_IAM_CLIENT_ACCESS_TOKEN?: string | undefined;

  DOCUSIGN_IAM_CLIENT_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  DOCUSIGN_IAM_CLIENT_ACCESS_TOKEN: z.string().optional(),

  DOCUSIGN_IAM_CLIENT_DEBUG: z.coerce.boolean().optional(),
});
